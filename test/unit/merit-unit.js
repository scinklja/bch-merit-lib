...
describe('#merit.js', () => {
  ...
  describe('#getTokenUtxos', () => {
    it('should return token UTXOs for an SLP address', async () => {
      ...
      sandbox.stub(uut.wallet, 'getUtxos').resolves(mockData.mockGetUtxos)
  ...
  describe('#findTokenParent', () => {
    it('should get the parent of a token UTXO', async () => {
      ...
      sandbox
        ...
        .onCall(0).resolves([mockData.mockTxInputs])
        .onCall(1).resolves(mockData.mockParentTx03)
      sandbox
  ...
  describe('#getParentAge', () => {
    it('should get the age of the oldest parent', async () => {
      ...
      sandbox
        ...
        .onCall(0)
        .resolves(mockData.mockParentUtxo04)
        .onCall(1)
        .resolves(false)
  ...
  describe('#calcMerit', () => {
    ...
    // Mock live network calls
      ...
      sandbox.stub(uut, 'getParentAge').resolves(false)
